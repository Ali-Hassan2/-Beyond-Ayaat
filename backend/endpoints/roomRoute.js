...
const {
  ...
  deleteMember,
  getAllFilteredRooms,
} = require("../services/rooms.Controller")
const checkOwner = require("../interceptors/checkownerforroom")
const getRoomActivityLogs = require("../services/activity-logs-room.controller")
