    ...
    return (
        ...
        >
            ...
            <div className='up-content h-[200px] flex items-center justify-center text-4xl sm:text-5xl md:text-6xl lg:text-8xl flex-col mt-[70px] gap-2 text-center px-4 overflow-hidden '>
                <h1 className='text-white tracking-[3px] font-semibold'>Explore the Hidden Wisdom</h1>
                <h1 className='text-white tracking-[3px] font-semibold'>of the Qur'an</h1>
            </div>
            ...
            <div className='buttons h-auto w-full flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-[50px] mt-[50px] px-4 overflow-hidden'>
                <button className='w-full sm:w-[200px] h-[50px] text-[16px] sm:text-[20px] rounded-md text-white cursor-pointer' style={{ backgroundColor: "#48AFB6" }}>
                    Start Exploring
                </button>
